...
const ContactForm = () => {
  ...
  return (
    ...
    <video src="/vid/contact-form2.mp4" muted autoPlay loop playsInline className=' absolute bottom-[0rem] left-1/2 -translate-x-1/2  w-full h-full object-cover object-center'></video>
    {/*  */}
