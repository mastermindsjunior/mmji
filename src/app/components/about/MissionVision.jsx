    ...
    <section className="bg-primary py-20 text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {/* Mission Column */}
          <div className="p-8 rounded-xl bg-gradient-to-br from-primary-dark to-primary-darker shadow-2xl transform transition-all duration-300 hover:scale-105 hover:shadow-primary-dark">
            <h2 className="text-4xl font-extrabold mb-6  text-sec">Our Mission</h2>
          ...
          {/* Values Column */}
          <div className="p-8 rounded-xl bg-gradient-to-br from-primary-dark to-primary-darker shadow-2xl transform transition-all duration-300 hover:scale-105 hover:shadow-primary-dark">
            <h2 className="text-4xl font-extrabold mb-6 text-sec">Vision</h2>
