...
const WhyChooseUs = () => {
  return (
    <secction className=" w-full h-auto py-20 bg-gradient-to-tr from-black via-transparent to-primary-orange/20 flex justify-center items-center" >
        ...
        <div className=' 2xl:max-w-7xl max-w-6xl p-0.5 rounded-2xl bg-gradient-to-t from-blue-600 via-gray-700 to-gray-800 relative overflow-hidden'>
        {/*  */}
            <div className=' absolute h-0.5 left-1/2 -translate-x-1/2 top-0 bg-gradient-to-r from-transparent via-blue-600 to-transparent w-[80%]' />
            <div className='absolute w-[50%] 2xl:h-20 h-14 rounded-b-[100%] opacity-30 bg-blue-600 blur-2xl z-10 top-0 left-1/2 -translate-x-1/2' />
        {/*  */}
