      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 text-sm relative">
        ...
        <div className="space-y-4 text-center md:text-left">
          ...
          <p className="text-white/60 max-w-xs">
            Building better digital experiences through design, code, and
            creativity.
          </p>
        ...
        <div className="space-y-3 md:text-right text-center">
          ...
          <p className="text-white/60">
            <a href="mailto:marketing@mastermindsjuniorindia.com">
              marketing@mastermindsjuniorindia.com
            </a>
          </p>
          <p className="text-white/60">
            <a href="tel:9423526131">9423526131</a>
          </p>

          <p className="text-white/60 text-xs leading-relaxed">
            1st Floor, Unit#105, near VPM Classes, Mansarovar, Jaipur, Rajasthan
            302020
          </p>
        </div>
