  ...
  return (
    <section className='w-full h-auto xl:p-12 p-4 py-4 flex justify-center items-center'>
      ...
      >
        ...
        <h2 className='fontjost font-bold 2xl:text-6xl xl:text-5xl text-3xl text-sec w-fit text-center xl:px-4 px-2 mx-auto relative z-10 leading-tight'>
          Welcome to <span className=" text-white">MasterMinds Junior</span>
          <br /> 
          <span className={`${scrolled ? "opacity-100 translate-y-0" : "opacity-0 translate-y-2"} transition-all ease-out duration-500 inline-block bg-gradient-to-r from-white to-sec bg-clip-text text-transparent`}>
            – Your Growth Catalyst
          </span>
        </h2>

        <div className='w-full space-y-8 relative z-10'>
          <div className='xl:w-[65%] w-full mx-auto flex flex-col justify-center items-start gap-6 font-sfth text-gray-100 2xl:text-base text-sm leading-relaxed'>
          ...
          <div className='w-full flex flex-wrap justify-center items-center gap-4 relative z-10'>
            ...
            <Link href='/about'>
              ...
              >
                ...
                <div className='rounded-full h-full aspect-square inline-flex justify-center items-center bg-primary p-2 group-hover/buttonCTA:bg-gray-900 transition-colors duration-300' style={{boxShadow:'0px 2px 8px rgba(0,0,0,0.2)'}}>
