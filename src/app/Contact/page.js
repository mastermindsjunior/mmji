...
const page = () => {
  return (
    <main>
      ...
      <section className=' max-w-7xl mx-auto flex gap-4 justify-center items-end mt-32 py-20 pt-32 relative'>
        ...
        <h2 className=' absolute z-10 top-4 left-1/2 -translate-x-1/2 font-jost font-bold text-8xl bg-gradient-to-b from-white/50 via-white/30 to-white/10 bg-clip-text text-transparent'>CONTACT</h2>


        <div className=' w-1/2 flex flex-col justify-between items-center relative z-20'>
            <div>
